...
export default function WebauthnAuthenticate(
  ...
  const webAuthnAuthenticate = useConstCallback(async () => {
    ...
    try {
      ...
      assert(
        typeGuard<AuthenticatorAssertionResponse>(
          response,
            ...
            (() => (
              <>
                {authenticators.authenticators.length > 1 && (
                  <p className={getClassName("kcSelectAuthListItemTitle")}>
                          ...
                          className={clsx(
                            (() => {
                              ...
                              return className.includes(" ")
                                ...
                                : [
                                    className,
                                    getClassName("kcWebAuthnDefaultIcon"),
                                  ];
                            })(),
                            getClassName(
